              ...
              {produits.map(produit => (
                <tr key={produit.numProduit} className="table-row">
                  {editMode === produit.numProduit ? (
                    <>
                      <td data-label="N°">{produit.numProduit}</td>
                      ...
                      <td data-label="Montant">{(editData.prix * editData.quantite).toFixed(2)}</td>
                    ...
                    <>
                      ...
                      <td data-label="Prix">{produit.prix.toFixed(2)}</td>
                      <td data-label="Quantité">{produit.quantite}</td>
                      <td data-label="Montant" className="montant-cell">{(produit.prix * produit.quantite).toFixed(2)}</td>
                      <td data-label="Actions">
